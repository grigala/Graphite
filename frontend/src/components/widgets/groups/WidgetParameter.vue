<template>
	<LayoutCol class="widget-parameter">
...
import { isWidgetRow, isWidgetParameter, type LayoutGroup, type WidgetParameter as WidgetParameterFromJsMessages } from "@/wasm-communication/messages";
...
const WidgetParameter = defineComponent({
	name: "WidgetParameter",
	inject: ["editor"],
	props: {
		widgetData: { type: Object as PropType<WidgetParameterFromJsMessages>, required: true },
	...
	methods: {
		...
		layoutGroupType(layoutGroup: LayoutGroup): unknown {
			...
			if (isWidgetParameter(layoutGroup)) return WidgetParameter;
...
export default WidgetParameter;
</script>
